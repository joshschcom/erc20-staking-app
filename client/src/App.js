...
function App() {
  ...
  const displayLogo = (symbol) => {
    if (symbol === "LINK") {
      return (
        <>
          <img className="logoImg" src="link.webp" />
        </>
      );
    } else if (symbol === "USDT") {
      return (
        <>
          <img className="logoImg" src="usdt.webp" />
        </>
      );
    } else if (symbol === "USDC") {
      return (
        <>
          <img className="logoImg" src="usdc.webp" />
        </>
      );
    } else if (symbol === "WBTC") {
      return (
        <>
          <img className="logoImg" src="wbtc.webp" />
        </>
      );
    } else if (symbol === "WETH") {
      return (
        <>
          <img className="logoImg" src="eth-logo.png" />
        </>
      );
    }
  };
